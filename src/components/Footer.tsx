        ...
        <div className="py-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem]">Tel: +91-7248909366</p>
              <p className="text-[0.8rem]">Email: research@thedalalstreethub.com</p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem]">Name: Santosh DK</p>
              ...
              <p className="text-[0.8rem]">UPI ID: santoshdk@okicici</p>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem]">Name: Mr Santosh DK</p>
              <p className="text-[0.8rem]">Email: compliance@thedalalstreethub.com</p>
              <p className="text-[0.8rem]">Tel: +91-7248909366</p>
            </div>
